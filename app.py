    ...
    with col1:
        ...
        if has_feat("Leukocytes"):
            inputs[key_for("Leukocytes")] = st.number_input(
                label_with_unit("Leukocytes"), min_value=0, value=0.0, format="%.2f",
        ...
        if has_feat("Waist Circumference"):
            inputs[key_for("Waist Circumference")] = st.number_input(
                label_with_unit("Waist Circumference"), min_value=0, value=0.0, format="%.1f",
    ...
    with col2:
        if has_feat("QUICK"):
            inputs[key_for("QUICK")] = st.number_input(
                label_with_unit("QUICK"), min_value=0, value=0.0, format="%.2f",
        ...
        if has_feat("APTT"):
            inputs[key_for("APTT")] = st.number_input(
                label_with_unit("APTT"), min_value=0, value=0.0, format="%.2f",
        ...
        if has_feat("Potassium"):
            inputs[key_for("Potassium")] = st.number_input(
                label_with_unit("Potassium"), min_value=0, value=0.0, format="%.2f",
        ...
        if has_feat("MCHC"):
            inputs[key_for("MCHC")] = st.number_input(
                label_with_unit("MCHC"), min_value=0, value=0.0, format="%.2f",
        ...
        if has_feat("MCH"):
            inputs[key_for("MCH")] = st.number_input(
                label_with_unit("MCH"), min_value=0, value=0.0, format="%.2f",
