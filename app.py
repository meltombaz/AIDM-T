...
st.markdown("""
<style>
/* Prevent OS dark mode surprises */
...
/* ===== Wider central container ===== */
.block-container{
  max-width: 1280px;                /* widen page */
...
/* ===== Header & info boxes ===== */
.header-box{ background:#004994; border-radius:14px; padding:1rem 1.5rem; margin-bottom:.6rem; }
...
/* ======= RADIO-AS-TABS  (Home / Info) — cross-browser, Safari+Chrome safe ======= */
...
/* inactive pill text — FORCE on all descendants */
.tab-radio [role="radio"],
.tab-radio [role="radio"] *,
...
/* ===== If you also use st.tabs anywhere else (same look) ===== */
.stTabs [data-baseweb="tab-list"]{ gap:.5rem; background:#004994; padding:.35rem; border-radius:12px; }
